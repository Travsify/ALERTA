...
// Check if Laravel is present - works from both root and public folder
$baseDir = file_exists(__DIR__ . '/artisan') ? __DIR__ : dirname(__DIR__);

if (!file_exists($baseDir . '/artisan')) {
    die('Error: Laravel files not found. Please upload all backend files first. Looking in: ' . $baseDir);
}
